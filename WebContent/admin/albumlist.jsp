		...
		<div class="nano-content">
			...
			<ul class="nav sidebar-menu">
				...
				<li class="active"><a class="accordion-toggle menu-open"
					href=""> <span class="glyphicons glyphicons-picture"></span> <span
						class="sidebar-title">轮播管理</span> <span class="caret"></span>
				</a>
					<ul class="nav sub-nav">
						<li class="active"><a href="admin/albumlist.jsp"> <span
		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">ICART外设商城轮播列表</a>
				</li>
					...
					<div class="panel panel-visible">
						<div class="panel-heading br-b-n">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>ICART外设商城轮播列表
							</div>
						</div>
						<div class="panel-body pn">
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${list }" var="music" varStatus="sta">

									<tr>
										<td>${sta.count}</td>
										<th>${music.music_name }</th>
										<th>${music.music_player }</th>
										<th>${music.music_time }</th>

										<th><a
											href="../ShowOneServlet?type=showone&id=${music.music_id}&pages=${pages}&counts=${counts}">查看详细</a></th>
										<th><a
											href="../UpdateServlet?type=update&id=${music.music_id}&pages=${pages}&counts=${counts}&start=${start}">修改</a></th>
										<th><a
											href="../DeleteMusicServlet?type=delete&id=${music.music_id}&pages=${pages}&counts=${counts}&start=${start}"
											onclick="return checkdel()">删除</a></th>
									</tr>
								</c:forEach>
							</table>
						</div>
