			...
			<ul class="nav sidebar-menu">
				...
				<li class="active"><a class="accordion-toggle menu-open"
					...
					<ul class="nav sub-nav">
						<li class="active"><a href="GetAllUserServlet?urole=admin"> <span
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${list }" var="u" >
									...
									<tr>
										...
										<th>${u.usersex }</th>
										<th>${u.usermail }</th>
										<th><a href="UserSelServlet?uid=${u.userid}&&urole=admin&&tp=get">查看详细</a></th>
										<th><a href="UserSelServlet?uid=${u.userid}&&urole=admin&&tp=up">修改</a></th>
										<th><a href="UserDelServlet?userid=${u.userid}&&urole=admin" onclick="return checkdel()">删除</a></th>
									</tr>
								</c:forEach>
							</table>
						</div>
