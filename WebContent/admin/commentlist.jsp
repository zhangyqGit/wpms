		...
		<div class="nano-content">
			...
			<ul class="nav sidebar-menu">
				...
				<li class="active"><a class="accordion-toggle menu-open"
					href=""> <span class="glyphicons glyphicons-star"></span> <span
						class="sidebar-title">评论管理</span> <span class="caret"></span>
				</a>
					<ul class="nav sub-nav">
						<li class="active"><a href="GetAllComServlet"> <span
		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">ICART外设商城评论列表</a>
				</li>
					...
					<div class="panel panel-visible">
						<div class="panel-heading br-b-n">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>ICART外设商城评论列表
							</div>
						</div>
						<div class="panel-body pn">
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${list }" var="com" varStatus="sta">

									<tr>
										<th>${com.proname }</th>
										<th><img width="80px" height="80px"
											src="ProImgServlet?fname=${com.proname}"></th>		
										<th>${com.username }</th>
										<th><img width="80px" height="80px"
											src="ProImgServlet?fname=${com.username }"></th>										
										<th>${com.comitem }</th>
										<th><a href="ComDelServlet?comid=${com.comid }" onclick="return checkdel()">删除</a></th>
									</tr>
								</c:forEach>
							</table>
						</div>
