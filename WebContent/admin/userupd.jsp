		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">用户列表</a>
				</li>
				...
				<div class="col-md-12">
					<div class="panel" style="height: 710px;">
						<div class="panel-heading">
							<span class="panel-title">修改用户信息 </span>
						</div>
						<div class="panel-body">
						<div style="position: absolute; margin-left: 700px;">
									<div class="col-lg-4">
									    点击头像可进行修改
										<img src="ProImgServlet?fname=${uu.username}"
									...
									<div id="comment" style="display: none;">
										...
										<br>
										<input type="submit" value="提交" class="sub_buttons">
										</form>
									</div>

								</div>
							<form class="form-horizontal" role="form" method="post"
								action="UpdUserServlet">
								<div class="form-group">
									<label for="inputPassword" class="col-lg-3 control-label">用户</label>
									<div class="col-lg-4">
										<input type="text" class="form-control" id="name" value="${uu.username }"
											name="username">
									    <input type="hidden" name="userid" value="${uu.userid}" />
									    <input type="hidden" name="urole" value="manord" />
									</div>
								</div>


								<div class="form-group">
									<label for="" class="col-lg-3 control-label">密码</label>
									<div class="col-lg-4">
										<input type="text" class="form-control" id=""
											value="${uu.userpwd}" name="userpwd">
									</div>
								</div>

								<div class="form-group">
									<label for="" class="col-lg-3 control-label">账户余额</label>
									<div class="col-lg-4">
										<input type="text" class="form-control" id=""
											value="${uu.useraccount }" name="useraccount" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
										<input type="text" class="form-control" id=""
											value="${uu.usersex }" name="usersex">
									</div>
								</div>

								<div class="form-group">
									<label for="" class="col-lg-3 control-label">邮箱</label>
									<div class="col-lg-4">
										<input type="text" class="form-control" id=""
											value="${uu.usermail}" name="usermail">
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-2"
