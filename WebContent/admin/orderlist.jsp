		...
		<div class="nano-content">
			...
			<ul class="nav sidebar-menu">
				...
				<li class="active"><a class="accordion-toggle menu-open"
					...
					<ul class="nav sub-nav">
						<li class="active"><a href="GetAllOrdServlet"> <span
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${olist }" var="od">
									<tr>
										...
										<th>${od.ordercount }</th>
										<th>${od.ordermoney }</th>
										<th><a href="OrderDilServlet?oid=${od.orderid }&&otime=${od.ordertime }&&ocount=${od.ordercount }&&omoney=${od.ordermoney }&&role=${user.userrole }">查看详细</a></th>
										<th><a href="OrderDelServlet?oid=${od.orderid }" onclick="return checkdel()">删除</a></th>
									</tr>
								</c:forEach>
							</table>
						</div>
