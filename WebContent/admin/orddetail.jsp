		...
		<div class="nano-content">
			...
			<ul class="nav sidebar-menu">
				...
				<li class="active"><a class="accordion-toggle menu-open"
					href="#"><span class="glyphicons glyphicons-file"></span> <span
						class="sidebar-title">订单管理</span> <span class="caret"></span> </a>
					<ul class="nav sub-nav">
		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">ICART外设商城订单列表</a>
				</li>
					...
					<div class="panel panel-visible">
						<div class="panel-heading br-b-n">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>ICART外设商城订单列表
							</div>
						</div>
								...
								<thead>
									<tr>
										<td colspan=3 style="text-align: center"><h3>
												<b>订单编号:${order.orderid }&nbsp;物品数量:${order.ordercount }&nbsp;订单总额:${order.ordermoney }&nbsp;下单时间:${otime }</b>
											</h3></td>
									</tr>
									<tr>
										<td>商品名</td>
								...
								<c:forEach items="${list}" var="ord" varStatus="states">
									<tr>
										...
										<td><img width="100px" height="100px"
											src="ProImgServlet?fname=${ord.proname}"></td>
										<td>${ord.ordercount }</td>
									</tr>
								</c:forEach>
								<tr><td colspan=3 align=center><a href="GetAllOrdServlet" class="btn btn-rounded btn-primary btn-block"
											style="margin-top: 17px;width: 150px;">返回</a></td></tr>
							</table>
						</div>
					</div>
				</div>
