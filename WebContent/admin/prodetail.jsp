						...
						<div class="panel-body">
							<form class="form-horizontal" role="form">						
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id="name"
												readonly="readonly" value="${pro.proname}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${pro.proprice}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${pro.proclass}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${pro.profirm }" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${pro.procount }" readonly="readonly">
										</div>
									</div>
