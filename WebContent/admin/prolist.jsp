		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">ICART外设商城商品列表</a>
				</li>
					...
					<div class="panel panel-visible">
						<div class="panel-heading br-b-n">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>ICART外设商城商品列表
							</div>
						</div>
						<div class="panel-body pn">
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${list }" var="pro" varStatus="sta">
									...
									<tr>
										<th><img width="100px" height="100px" src="ProImgServlet?fname=${pro.proname}"></th>
										<th>${pro.proname}</th>
										<th>${pro.proprice}</th>
										<th>${pro.proclass}</th>
										<th>${pro.profirm}</th>
										...
										<th><a href="ProDetailServlet?proid=${pro.proid}&&urole=${user.userrole }&&tp=get">查看详细</a></th>
										<th><a href="ProDetailServlet?proid=${pro.proid}&&urole=${user.userrole }&&tp=up">修改</a></th>
										<th><a href="ProDelServlet?proid=${pro.proid}" onclick="return checkdel()">删除</a></th>
									</tr>
								</c:forEach>
							</table>
						</div>
