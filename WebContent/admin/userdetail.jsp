...
<body class="Home-page sb-l-o sb-r-c">
	...
	<div id="main">
		...
		<!-- End: Topbar-Dropdown --> <!-- Start: Topbar --> 
		<header id="topbar">
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active"><a href="#"
					style="text-decoration: none; font-family: 幼圆; font-size: 15px;">专辑列表</a>
				</li>
		...
		<div id="content">
			<div class="row">
				<div class="col-md-12">
					<div class="panel" style="height: 590px;">
						<div class="panel-heading">
							<span class="panel-title">用户信息详情</span>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" role="form">						
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id="name"
												readonly="readonly" value="${uu.username }">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${uu.userpwd}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${uu.useraccount }" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${uu.usersex }" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id=""
												value="${uu.usermail}" readonly="readonly">
										</div>
									</div>
								...
								<div class="form-group">
									<div class="col-xs-2"
										...
										<a href="GetAllUserServlet?urole=orduser"
