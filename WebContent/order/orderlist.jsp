					...
					<tbody>
						<c:forEach items="${list}" var="ord" varStatus="states">
							<tr>
								...
								<td><a
									href="OrderDilServlet?oid=${ord.orderid }&&otime=${ord.ordertime }&&ocount=${ord.ordercount }&&omoney=${ord.ordermoney }&&role=${user.userrole }"
									style="width: 120px;"><span>查看明细</span></a></td>
							</tr>
						</c:forEach>
